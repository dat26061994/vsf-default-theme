...
const Cart = () => import(/* webpackChunkName: "vsf-reset-password" */ 'theme/pages/Cart.vue');
const Search = () => import(/* webpackChunkName: "vsf-reset-password" */ 'theme/pages/Search.vue');
