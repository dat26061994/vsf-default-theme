<template>
  <div id="home">
    ...
    <features-image-content positionImage="left">
      <template slot="image">
        <img class="p-3 w-100" src="https://img.btdmp.com/files/10110793/2020/09/10/0x720@1599727788a159ee8f37.jpeg" alt="">
      </template>
      <template slot="content">
        <div class="p-3">
          <h4>Water Tracker Bottle with Inspired Designs</h4>
          <p>Stay hydrated and elegant with 64Hydro's awesome reusable water bottles. We are inspired by contemporary art and always find the best way to combine styles for unique designs.  Whether you prefer steel or plastic, a stunning look or a funny quote, you're sure to find water bottles for your healthy life!</p>
    ...
    <slider title="Popular Products" :perPage="6" :products="getEverythingNewCollection" />
