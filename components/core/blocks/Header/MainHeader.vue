	...
	<div class="main-header">
		...
		<div class="pt-1">
					...
					<div class="row bg-white align-items-center">
						<div class="col-md-9">
							<div class="row px-md-4">
								...
								<div class="col-md-9 col-sm-8  px-md-4">
									<div class="span12">
										<div
											class="custom-search-container d-flex justify-content-center"
										>
											...
											<input
												...
												class="search-query mac-style p-2"
			...
			<div class="d-sm-block d-md-none">
				<div class="row px-xs-4 px-4">
					<div
						class="col-xs-1 d-flex align-items-center px-0 justify-content-start justify-content-sm-start"
					>
						<hamburger-icon class="p15 icon bg-white pointer" />
					</div>
					<div
						class="col-xs-5 px-0 d-flex justify-content-start align-items-center"
					>
						<logo height="40" width="auto" />
					</div>
