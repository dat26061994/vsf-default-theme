<template>
  <section class="head-image w-100 bg-cl-th-accent cl-white">
    <div class="container w-100 h-100 cl-black d-flex justify-content-center align-items-center text-white text-center" v-lazy:background-image="currentImage.image" v-if="currentImage">
      <div class="head-image-content">
        <h1 class="title" data-testid="mainSliderTitle">
          {{ currentImage.title }}
        </h1>
        <p
          class="subtitle mb0 serif h3 mt-3"
          data-testid="mainSliderSubtitle"
        >
          {{ currentImage.subtitle }}
        </p>
        <div class="mt-3 d-flex justify-content-center align-items-center mx-auto">
          <router-link class="btn-add-to-cart" to="">
            Shop now
          </router-link>
        </div>
