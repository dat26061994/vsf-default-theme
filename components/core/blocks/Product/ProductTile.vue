<template>
  <div class="product w-100 pb-2" v-observe-visibility="visibilityChanged">
    ...
    >
      ...
      <p class="mb0 product-name cl-accent mt10 p-2 mb-2" v-if="!onlyImage">
        {{ product.name | htmlDecode }}
      </p>

      <span
        class="price-original mr5 lh30 cl-secondary p-2"
      ...
      <span
        class="price-special lh30 cl-accent weight-700 p-2"
        v-if="product.special_price && parseFloat(product.special_price) > 0 && !onlyImage"
      >{{ product.price_incl_tax | price(storeView) }}</span>

      <span
        class="lh30 cl-secondary p-2"
