<template>
    ...
    <div class="d-flex d-flex justify-content-center align-items-center p-2">
        <button class="btn-add-to-cart w-100" type="button" @click="addToCart(product)" :disabled="isProductDisabled" data-testid="addToCart">
            <span v-if="!isProductDisabled">{{ $t('Add to cart') }}</span> 
